...
def InitAdaIAT(args, beta):
    ...
    if param=="llava-v1.5-7b":
        data=torch.load("/home/amax/check/zla/hallucination/hallucination/Devil/llava_direction_1w.pt")
    else:
        data=torch.load("/home/amax/check/zla/hallucination/hallucination/Devil/llava_13b_direction_1w.pt")
